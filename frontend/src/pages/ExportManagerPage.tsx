...
export default function ExportManagerPage() {
    ...
    // Filtrowanie dystrybutorów według wyszukiwania
    const filteredDistributors = distributors.filter(d => 
        d.company_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        d.country.toLowerCase().includes(searchTerm.toLowerCase())
    );

    const uniqueDistributorNames = [...new Set(distributors.map(d => ({ id: d.id, name: d.company_name })))];
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {uniqueDistributorNames.map(dist => (
